...
<x-layouts.plain :title="__('Home')">
    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="mx-auto flex max-w-6xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-0">
            ...
            <header class="w-full rounded-2xl overflow-hidden relative shadow-lg">
                ...
                <div class="absolute inset-0 z-20 flex flex-col justify-center p-8 text-white rounded-2xl">
                    <div class="max-w-xl">
                        ...
                        <p class="text-lg mt-3 max-w-md">{{ __('Jelajahi katalog premium pilihan kami dan temukan potongan yang paling cocok untuk kebutuhan kuliner Anda.') }}</p>
            ...
            <section class="rounded-2xl border border-gray-200 bg-white p-6 shadow-md">
                <div class="max-w-6xl mx-auto text-center px-4">
                    ...
                    <!-- Judul -->
                    <h2 class="text-3xl text-black font-bold text-center mt-4 mb-12">
                        KENAPA HARUS BER BELANJA DI JURAGAN99
                    </h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-14">
                        ...
                        <div class="flex flex-col items-center">
                           <img src="{{ asset('icons/Halal.svg') }}" class="w-24 mb-6">
                            <h3 class="text-2xl font-semibold mb-3">Halal</h3>
                            <p class="text-gray-600 text-lg">
                                Kami menyediakan produk yang bersertifikasi halal.
                            </p>
                        </div>

                        <!-- Higienis -->
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('icons/Higienis (1).svg') }}" class="w-24 mb-6">
                            <h3 class="text-2xl font-semibold mb-3">Higienis</h3>
                            <p class="text-gray-600 text-lg">
                                Produk produk kami terjamin kebersihannya.
                            </p>
                        </div>

                        <!-- Terjangkau -->
                        <div class="flex flex-col items-center">
                            <img src="{{ asset('icons/Terjangkau (1).svg') }}" class="w-24 mb-6">
                            <h3 class="text-2xl font-semibold mb-3">Terjangkau</h3>
                            <p class="text-gray-600 text-lg">
                                Kami menyediakan produk dengan harga yang terjangkau.
                            </p>
                        </div>
        ...
        <footer class="mt-12 border-t border-gray-200 bg-white">
            <div class="mx-auto max-w-6xl px-4 py-20 sm:px-6 lg:px-0 text-center text-sm text-gray-500">
              {{ date('Y') }} Terima kasih sudah berbelanja di Juragan99. Selalu sediakan daging segar untuk keluarga Anda!{{ __() }}
            </div>
        </footer>
    </div>
