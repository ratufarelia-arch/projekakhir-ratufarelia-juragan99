...
<x-layouts.app :title="__('Orders')">
    <div class="min-h-screen bg-zinc-50 font-sans text-zinc-900 p-4 lg:p-8 rounded-2xl">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            {{-- Optional: Filter / Search Action --}}
            <div class="flex gap-2">
                <div class="relative">
                    <input type="text" placeholder="Cari Order ID / Nama..." class="rounded-lg border border-zinc-200 bg-white px-4 py-2 text-sm text-zinc-700 shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-1 focus:ring-emerald-500 w-64">
